...
contract DYNAToken is BEP20('Dynamis Token', 'DYNA'), MinterRole, Ownable {
    using SafeMath for uint256;
    uint256 public constant INITIAL_SUPPLY = 150000*1e18;
    uint256 public constant PRESAL_SUPPLY = 150000*1e18;
    ...
    constructor() public {
        ...
        _mint(msg.sender, PRESAL_SUPPLY);
        pausable = false;
    }
    ...
    function _transfer(address _sender, address _recepient, uint256 _amount) internal override antiWhale {
        require (msg.sender == isMinter() || puasable == false, 'token transferring paused');
